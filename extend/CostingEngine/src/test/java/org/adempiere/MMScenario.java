...
public class MMScenario
{
	...
	public final String MMPolicy = MProductCategory.MMPOLICY_FiFo;
	public final String CostingLevel = MProductCategoryAcct.COSTINGLEVEL_Organization;
	public final String CostingMethod = MProductCategoryAcct.COSTINGMETHOD_Fifo;
	...
	public MMDocument get(String docBaseType, String documentNo)
	{
		...
		{
			if (docBaseType.equals(doc.DocBaseType) && documentNo.equals(doc.DocumentNo))
				return doc;
		}
