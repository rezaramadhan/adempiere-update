...
INSERT INTO AD_Element (AD_Client_ID,AD_Element_ID,AD_Org_ID,AD_Reference_ID,ColumnName,Created,CreatedBy,Description,EntityType,FieldLength,IsActive,Name,PrintName,Updated,UpdatedBy) VALUES (0,55913,0,11,'ACTriggerLength',TO_TIMESTAMP('2013-06-14 16:40:26','YYYY-MM-DD HH24:MI:SS'),100,'Identifier autocomplete trigger length','D',10,'Y','Auto Complete Min Length','Auto Complete Min Length',TO_TIMESTAMP('2013-06-14 16:40:26','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
ALTER TABLE AD_Table ADD COLUMN ACTriggerLength NUMERIC(10) DEFAULT '0' 
;

-- Jun 14, 2013 4:42:51 PM EEST
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,HideInListView,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,PreferredWidth,SeqNo,SortNo,Updated,UpdatedBy) VALUES (0,65574,66948,0,100,TO_TIMESTAMP('2013-06-14 16:42:51','YYYY-MM-DD HH24:MI:SS'),100,'Identifier autocomplete trigger length',0,'D','N','Y','Y','Y','N','N','N','N','N','Auto Complete Min Length',0,200,0,TO_TIMESTAMP('2013-06-14 16:42:51','YYYY-MM-DD HH24:MI:SS'),100)
;
