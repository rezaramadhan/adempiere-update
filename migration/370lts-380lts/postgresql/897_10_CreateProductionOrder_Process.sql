...
INSERT INTO AD_Process (AccessLevel,AD_Client_ID,AD_Org_ID,AD_Process_ID,Classname,CopyFromProcess,Created,CreatedBy,Description,EntityType,Help,IsActive,IsBetaFunctionality,IsDirectPrint,IsReport,IsServerProcess,Name,ShowHelp,Statistic_Count,Statistic_Seconds,Updated,UpdatedBy,Value) VALUES ('3',0,0,53477,'org.compiere.process.OrderLineCreateProduction','N',TO_TIMESTAMP('2013-10-01 10:26:28','YYYY-MM-DD HH24:MI:SS'),0,'Create Production Order','D','Create Production Order','Y','N','N','N','N','Create Production Order','Y',0,0,TO_TIMESTAMP('2013-10-01 10:26:28','YYYY-MM-DD HH24:MI:SS'),0,'Create Production Order')
;
...
-- "Create Production Order" process is created
INSERT INTO AD_Element (AD_Client_ID,AD_Element_ID,AD_Org_ID,AD_Reference_ID,ColumnName,Created,CreatedBy,Description,EntityType,FieldLength,Help,IsActive,Name,PrintName,Updated,UpdatedBy) VALUES (0,56423,0,20,'IgnorePrevProduction',TO_TIMESTAMP('2013-10-01 10:28:24','YYYY-MM-DD HH24:MI:SS'),0,'IgnorePrevProduction','D',1,'IgnorePrevProduction','Y','IgnorePrevProduction','IgnorePrevProduction',TO_TIMESTAMP('2013-10-01 10:28:24','YYYY-MM-DD HH24:MI:SS'),0)
;
...
-- "Create Production Order" process is created
INSERT INTO AD_Process_Para (AD_Client_ID,AD_Element_ID,AD_Org_ID,AD_Process_ID,AD_Process_Para_ID,AD_Reference_ID,ColumnName,Created,CreatedBy,Description,EntityType,FieldLength,Help,IsActive,IsCentrallyMaintained,IsMandatory,IsRange,Name,SeqNo,Updated,UpdatedBy) VALUES (0,56423,0,53477,54107,20,'IgnorePrevProduction',TO_TIMESTAMP('2013-10-01 10:28:46','YYYY-MM-DD HH24:MI:SS'),0,'IgnorePrevProduction','D',1,'IgnorePrevProduction','Y','Y','N','N','IgnorePrevProduction',20,TO_TIMESTAMP('2013-10-01 10:28:46','YYYY-MM-DD HH24:MI:SS'),0)
;
...
UPDATE AD_Process SET Name='CreateProductionOrder', Value='CreateProductionOrder',Updated=TO_TIMESTAMP('2013-10-01 10:35:09','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Process_ID=53477
;
